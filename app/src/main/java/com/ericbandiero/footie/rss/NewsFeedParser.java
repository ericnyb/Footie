 ...
 */
public class NewsFeedParser implements IDateFilter {

    //    public static final int days_old = 14;
    private int days_old_published;
    ...
    public NewsFeedParser(String urlString, int days_old) {
        this.urlString = urlString;
        this.days_old_published = days_old;
    }
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (tagName.equals(CHANNEL)) {
                            ...
                            if (dateFilter.isDateOk(pubDate, days_old_published)) {
                                rssFeed = new RSSFeed(title, link, description, category, pubDate, guid, feedburner, RSSAsychActivity.getColorFromMap(urlString));
    ...
    public boolean isDateOk(String pub_date, int days_old) {
        ...
        return dateFilter.isDateOk(pub_date, days_old);
    }
}
